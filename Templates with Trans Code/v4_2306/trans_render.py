...
def getData(row):
    ...
    if 'authors' in data and data['authors'] != "":
        ...
        telugu_data_dict['english_authors'] = data['authors']
    else:
        telugu_data_dict['authors'] = ""
        telugu_data_dict['english_authors'] = ""
    ...
    telugu_data_dict['english_book_title'] = data['book_title']
    # language
    ...
    if 'author1_name' in data and data['author1_name'] != "":
        ...
        telugu_data_dict['english_author1_name'] = data['author1_name']
    else:
        telugu_data_dict['author1_name'] = ""
        telugu_data_dict['english_author1_name'] = ""
    ...
    if 'librarything_book_summary' in data and data['librarything_book_summary'] != "":
        ...
        if book_summary[-34:] == "--Publisher's description.… (more)":
        	book_summary = book_summary[:-34]
        if book_summary[-26:] == "--Publisher's description.":
        	book_summary = book_summary[:-26]
        elif book_summary[-8:] == '… (more)':
            book_summary = book_summary[:-8]
    ...
    telugu_data_dict['book_image'] = data['book_image']
...
p = pickle.load(open('merged_pickle_v37.pkl','rb'))
row = p.loc[1669]
data = getData(row)
