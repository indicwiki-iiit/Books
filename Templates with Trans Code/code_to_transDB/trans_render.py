...
def getData(row):
    ...
    if 'published_date' in data and data['published_date'] != "":
        telugu_data_dict['published_date'] = data['published_date']
    ...
    #large_thumbnail_link
    if 'large_thumbnail_link' in data and data['large_thumbnail_link']!="":
        telugu_data_dict['large_thumbnail_link'] = data['large_thumbnail_link']
    else:
        telugu_data_dict['large_thumbnail_link'] = ''
    ...
    telugu_data_dict['goodreads_link'] = data['goodreads_link']
    telugu_data_dict['librarything_url'] = data['librarything_url']
    telugu_data_dict['worldcat_url'] = data['worldcat_url']
    telugu_data_dict['author1_wiki'] = data['author1_wiki']
    telugu_data_dict['awards_as_category'] = data['awards_as_category']
    ...
    if 'average_rating' in data and data['average_rating'] != "":
        ...
        telugu_data_dict['average_rating'] = ""
    ...
    if 'goodreads_ratings_count' in data and data['goodreads_ratings_count'] != "":
        ...
        telugu_data_dict['goodreads_ratings_count'] = ''
    ...
    #more_by_author
    if 'more_by_author' in data and data['more_by_author'] != "":
        temp = list()
        for i in data['more_by_author']:
            temp.append(translit(i)[0]['pred'])
        telugu_data_dict['more_by_author'] = temp
    else:
        telugu_data_dict['more_by_author'] = ""
    ...
    if 'categories' in data:
        ...
        telugu_data_dict['CATEGORY_GENRE'] = '[[Category: ' + category + ' పుస్తకాలు'+']]'

    # CATEGORY_LANGUAGE
    if 'language' in data:
        language = d_language[data['language']]
        telugu_data_dict['CATEGORY_LANGUAGE'] = '[[Category: ' + language + ' పుస్తకాలు'+']]'
    
    #CATEGORY_AWARDS
    if 'CATEGORY_AWARDS' in data:
        if data['CATEGORY_AWARDS']=='':
            telugu_data_dict['CATEGORY_AWARDS']=''
        else:
            telugu_data_dict['CATEGORY_AWARDS'] = data['CATEGORY_AWARDS']



    for i in telugu_data_dict.keys():
        if i not in LIST_OF_ATTRIBUTES:
            print(i)
...
# template = env.get_template("template_merged.j2")

# p = pickle.load(open('merged_pickle_v33.pkl','rb'))
# row = p.loc[3571]
# data = getData(row)
...
p = pickle.load(open('merged_pickle_v34.pkl','rb'))
df = pd.DataFrame(columns = LIST_OF_ATTRIBUTES)
#3474,3515
for i in range(15,18):
    ...
    pickle.dump(df,open('trans_v1.pkl','wb'))
