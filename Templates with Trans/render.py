...
def clean_published_date(row):
    ...
    # But dates from this attribute have 118 missing values, while the ones from the 'published_date' attribute have 0 null values, though in inconsistent date formats.
...
def getInfo(row): 
    ...
    AU_WIKI_LINK = "<ref name='au-link'>{{{{cite web |url={} |title={} - వికీపీడియా}}}}</ref>".format(AU,row['author1_name'])
